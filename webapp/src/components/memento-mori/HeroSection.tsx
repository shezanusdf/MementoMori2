...
export function HeroSection({ onScrollToPersonalizer }: HeroSectionProps) {
  return (
    <section className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 md:px-12 lg:px-24 pt-4 max-w-5xl">
        <div className="space-y-6 sm:space-y-10 md:space-y-12">
          {/* Opening Hook */}
          <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-serif leading-[1.1] animate-fade-in">
          ...
          {/* The Philosophy */}
          <div className="space-y-3 sm:space-y-4 max-w-2xl animate-fade-in-delay-1 -mt-2 sm:-mt-4">
          ...
          <div className="animate-fade-in-delay-2">
            <Button
              ...
              className="bg-foreground text-background hover:bg-foreground/90 rounded-full px-6 sm:px-10 py-5 sm:py-7 text-base sm:text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300 active:scale-[0.98]"
            >
          ...
          <div className="py-4 sm:py-6 animate-fade-in-delay-3 overflow-x-auto">
            <div className="flex flex-col gap-[3px] sm:gap-[4px]">
              <div className="flex gap-[3px] sm:gap-[4px]">
                {Array.from({ length: 40 }).map((_, i) => (
                  <div
                    key={i}
                    className="w-[7px] h-[7px] sm:w-[10px] sm:h-[10px] rounded-[1.5px] sm:rounded-[2px] flex-shrink-0"
